export const apiData = {
  overview: {
    ...
    description: 'ATMA API Gateway adalah entry point tunggal untuk semua komunikasi dengan backend services. Gateway ini mengelola routing, authentication, rate limiting, dan security untuk seluruh sistem ATMA (AI-Driven Talent Mapping Assessment).',
    baseUrl: 'https://api.chhrone.web.id',
    version: '1.0.0',
    architecture: {
      title: 'Architecture Overview',
      description: 'Client Application → API Gateway (Port 3000) → Services (Auth: 3001, Archive: 3002, Assessment: 3003, Notification: 3005)'
    }
  },
  
  authentication: {
    title: 'Authentication & User Management',
    description: 'Sistem autentikasi menggunakan JWT token untuk sebagian besar endpoint.',
    endpoints: [
      {
        title: 'Register User',
        method: 'POST',
      ...
      },
      {
        ...
        headers: ['Authorization: Bearer <token>'],
        warning: 'Operasi ini tidak dapat dibatalkan. User email akan diubah ke format deleted_{timestamp}_{original_email}'
      }
    ]
  },
  ...
  assessment: {
    ...
    description: 'Service untuk submit dan monitoring assessment AI-Driven Talent Mapping',
    endpoints: [
      {
  ...
  archive: {
    ...
    endpoints: [
      ...
      },
      {
        ...
        method: 'DELETE',
        url: '/api/archive/results/:id',
        description: 'Hapus hasil analysis (user hanya bisa hapus milik sendiri)',
        headers: ['Authorization: Bearer <token>'],
        response: {
          success: true,
